...
export default function MyDrawer() {
    return (
        <Drawer.Navigator drawerContent={props => <CustomDrawerContent {...props} />}>
            ...
            />
            <Drawer.Screen name="Bajigar" component={Bajigar} 
            options={{
                drawerIcon: ({ focused, color, size }) => (
                    <Icon name="book" style={{ fontSize: size, color: color }} />
                )
            }}/>
            <Drawer.Screen name="Parrot" component={Parrot} 
            options={{
                drawerIcon: ({ focused, color, size }) => (
                    <Icon name="book" style={{ fontSize: size, color: color }} />
                )
            }}/>
            <Drawer.Screen name="Love Bird" component={LoveBird} 
            options={{
                drawerIcon: ({ focused, color, size }) => (
                    <Icon name="book" style={{ fontSize: size, color: color }} />
                )
            }}/>
            <Drawer.Screen name="Hen" component={Hen} 
            options={{
                drawerIcon: ({ focused, color, size }) => (
                    <Icon name="book" style={{ fontSize: size, color: color }} />
                )
